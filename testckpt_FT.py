...
if __name__ == '__main__':
    ...
    config_args.experiment_name = 'testckpt_FT'
    test_loader = DataLoader(FT(config_args.data_path, 'test', crop_train=True), batch_size=1, shuffle=False)

    model = TradRDNet(config_args)
    pth_path = r".\checkpoints\ckpt_FT.pth"
